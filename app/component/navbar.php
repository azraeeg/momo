                        ...
                        <div class="rbt-header-content">
                            <!-- <div class="header-info">
                                <ul class="rbt-information-list">
                                    <li>
                                        <a href="#"><i class="feather-phone"></i>(024)7625005</a>
                                    </li>
                                </ul>
                            </div> -->
                            <div class="header-info">
                        ...
                        <div class="rbt-header-content">
                            <div class="header-info">
                                <ul class="rbt-information-list">
                                    ...
                                    <li>
                                        <a href="#"><i class="feather-clock "></i>Buka 24 Jam</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="feather-mail "></i>rspm.smg@gmail.com</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="header-info">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="#">
                    <img src="assets/images/logo/logo.png" alt="logo rspm" style="width: 100px; height: auto;">
                </a>
                <!-- Toggler for mobile -->
